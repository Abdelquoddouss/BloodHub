                                ...
                                <div class="post-details-content">
                                    <div class="post-details-body">
                                        <div class="content">
                                            ...
                                            <div class="meta">
                                                <a class="category"
                                                    href="{{ route('categories.show', $center->category_id) }}">{{ $center->category->name }}</a>
                                                <span>-</span> {{ $center->created_at->format('M d, Y') }} by <a
                                                    class="author"
                                                    href="#">{{ $center->user ? $center->user->name : 'Admin' }}</a>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <strong>Ouverture:</strong> <span
                                                        class="badge bg-success text-light">{{ $center->overture }}</span>
                                                </div>
                                                <div class="col">
                                                    <strong>Fermeture:</strong> <span
                                                        class="badge bg-danger text-light">{{ $center->fermeture }}</span>
                                                </div>
                                            </div>
                                            <br>
                                            <hr> <!-- Ajout d'une ligne horizontale pour séparer le contenu -->
                                            <ul class="list-unstyled">
                                                <li class="mb-2"><strong>Adresse:</strong> {{ $center->adresse }}
                                                </li>
                                                <li class="mb-2"><strong>Email:</strong> {{ $center->email }}</li>
                                                <li class="mb-2"><strong>Téléphone:</strong> {{ $center->phone }}
                                                </li>
                                                <li class="mb-2"><strong>Description:</strong>
                                        ...
                                        <div class="text-center">
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#reservationModal">Réserver pour le don de
                                                sang</button>
                                        </div>
                                        <br>
                                                    ...
                                                    @foreach ($latestCenters as $center)
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="post-item">
                                                                <div class="thumb">
                                                                    <a
                                                                        href="{{ route('centers.show', $center->id) }}">
                                                                ...
                                                                <div class="content">
                                                                    <a href="{{ route('centers.show', $center->id) }}"
                                                                        class="category">{{ $center->nom }}</a>
                                                                    <h4 class="title">
                                                                        <a
                                                                            href="{{ route('centers.show', $center->id) }}">{{ $center->nom }}</a>
                                                                    </h4>
                                                                </div>
                                                            </div>
                                                            <!--== End Blog Post Item ==-->
                        ...
                        <div class="widget-item">
                            <div class="about-widget">
                                ...
                                <ul class="widget-contact-info">
                                    ...
                                    <li class="info-phone">
                                        <i class="icofont-ui-call"></i><a href="tel://(0091)8547632521">(0091) 8547
                                            632521</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="widget-copyright">
                                <p>
                                    ...
                                    <a target="_blank" href="https://www.hasthemes.com">HasThemes</a>
                                </p>
                            </div>
                        </div>
                    </div>
