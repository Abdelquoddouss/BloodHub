            ...
            <main class="main-content site-wrapper-reveal">
                ...
                <section class="blog-area section-py blog-border-bottom">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="post-items-style2" id="events-list">
                                </div>
                                        ...
                                        <div class="post-item">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="meta">Posted on
                                                    {{ $center->created_at->format('M d, Y') }} by <a class="author"
                                ...
                                <div class="sidebar-wrapper blog-sidebar-wrapper">
                                    ...
                                    <div class="widget-item">
                                        ...
                                        <div class="widget-search-box">
                                            <form id="searchForm" action="{{ route('centers.filter') }}"
                                                method="POST">
                                                @csrf
                                                <input type="text" name="nom" id="searchInput"
