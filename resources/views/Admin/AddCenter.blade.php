                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nom" class="form-control" id="project-title-input"
                                placeholder="Enter Center title">
                        </div>

                        <div class="mb-3">
                            <label class="form-label" for="project-title-input">Center email</label>
                            <input type="email" name="email" class="form-control" id="project-title-input"
                                placeholder="Enter email  Center">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="adresse" class="form-control" id="project-title-input"
                                placeholder="Enter adress Center">
                        </div>
                    ...
                    <div class="card-body">
                        <div>
                            <div class="mb-3">
                                ...
                                <input type="text" name="phone" class="form-control" id="project-title-input"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select name="category_id" class="form-select" data-choices="" data-choices-search-false=""
