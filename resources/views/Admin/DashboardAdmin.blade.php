                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="/DashboardAdmin" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('img/bs-blood-hub.png') }}" alt="" height="22" />
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('img/bs-blood-hub.png') }}" alt="" height="17" />
                                </span>
                            </a>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="/Static">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('Admin.result') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('reservation.index') }}">
