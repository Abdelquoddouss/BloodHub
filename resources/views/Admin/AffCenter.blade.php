        ...
        <tr>
            ...
            <td>
                <div class="hstack gap-3 flex-wrap">
                    ...
                    <form id="delete-form-{{ $center->id }}" action="{{ route('centers.destroy', $center->id) }}" method="POST" style="display: none;">
                        @csrf
                        @method('DELETE')
                    </form>
                    <button type="button" class="link-danger fs-15 delete-btn" data-id="{{ $center->id }}" style="background: none; border: none; color: red;"><i class="ri-delete-bin-line"></i></button>
                </div>
            </td>
        </tr>
        @endforeach
